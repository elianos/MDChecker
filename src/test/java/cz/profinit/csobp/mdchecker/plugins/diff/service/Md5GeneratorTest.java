...
public class Md5GeneratorTest {
	...
	public void generateMd5Test() throws IOException {
		String md5 = md5Generator.generateMd5(new File("src/test/resources/plugins/diff/ClassOld.txt"));
		String excepted = "821ae7262793725b71e914c5932c80ec";
		Assert.assertEquals(excepted, md5);
		
		md5 = md5Generator.generateMd5(new File("src/test/resources/plugins/diff/ClassNew.txt"));
